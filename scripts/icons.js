// Builds the icon sprite from lib/icons.js: only the Phosphor icons in use (MIT, regular
// weight), as inline SVG symbols, plus the list the app reads for the picker and the tints.
...
console.log(`${Object.keys(ICONS).length + Object.keys(EXTRA).length} icons, ${Math.round(sprite.length / 1024)} KB`);
