// Dev only (SPAN_MOCK=1): a stand in for Claude so the UI can be worked on without a key.
...
async function create(req) {
  ...
  if (mode === 'plan') {
    ...
    out = {
      ...
      review: mode === 'review' ? 'Runs held. Nights slipped late in the span. Mock read, not Claude.' : '',
    };
  }
