...
const { TOOLS, STATUS_TOOL, SUMMARY_TOOL, OFF_TOPIC_TOOL, TRIM_TOOL, working, runTool } = require('./tools');
...
When they say "Use the suggestion", the app has already lowered the counts: propose the schedule. When they say "Keep mine", plan the counts they asked for as well as you can, and say plainly in one sentence what gets squeezed. If they accept the trim in their own words, lower the targets with update_goals, then propose.
