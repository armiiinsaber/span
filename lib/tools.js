...
const HANDLERS = { update_goals: updateGoals, log_day: logDay, propose_schedule: proposeSchedule, show_status: showStatus, mark_off_topic: markOffTopic, suggest_trim: suggestTrim, save_summary: saveSummary };
...
module.exports = { TOOLS, STATUS_TOOL, SUMMARY_TOOL, OFF_TOPIC_TOOL, TRIM_TOOL, TAGS, TAG_NAMES, working, runTool, WORK_DAYS };
