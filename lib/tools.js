...
const HANDLERS = { update_goals: updateGoals, log_day: logDay, propose_schedule: proposeSchedule, show_status: showStatus, save_summary: saveSummary };
...
module.exports = { TOOLS, STATUS_TOOL, SUMMARY_TOOL, TAGS, TAG_NAMES, working, runTool, WORK_DAYS };
