...
const TOOLS = [
  ...
  {
    name: 'log_day',
    description: 'Mark what got done or missed on one day that has already started. Use it during check ins. Marking done something that was planned for a later day moves one of those later sessions to this day.',
    strict: true,
    input_schema: {
  ...
  },
  {
    ...
    description: 'Propose where the remaining sessions go. List every session that is still to happen, for every goal. Done and missed sessions are fixed and must not be listed. The person sees a card with your changes and confirms or asks for tweaks; nothing changes until they confirm.',
    strict: true,
    input_schema: {
...
function proposeSchedule(input, w) {
  ...
  return {
    ...
    result: 'Shown to the person as a card with Confirm and Tweak. It is not applied until they confirm. Do not repeat the changes in your reply; one short line at most.',
  };
}
